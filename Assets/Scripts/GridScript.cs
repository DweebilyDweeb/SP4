...
public class GridScript : MonoBehaviour {
	...
	public GridID id;                                      // ID of each tile, ID = currentRow * numberOfColumns + currentColumn
	public GridID[] neighbourIDs;							// Neighbouring tiles of a tile, UP, DOWN, LEFT, RIGHT
